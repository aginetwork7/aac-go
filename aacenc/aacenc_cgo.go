...
/*
#cgo linux,arm CFLAGS: -g3 -O0 -std=gnu99 -Iexternal/aacenc/include -DUSE_DEFAULT_MEM -DARMV5E -DARMV7Neon -DARM_INASM -DARMV5_INASM -DARMV6_INASM -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=neon -Wall -D__ARM_ARCH_7A__
#cgo linux,arm LDFLAGS: -g3 -mfloat-abi=hard -mfpu=neon -L. -l:AutoCorrelation_v5.o -l:CalcWindowEnergy_v5.o -l:band_nrg_v5.o -l:PrePostMDCT_v7.o -l:R4R8First_v7.o -l:Radix4FFT_v7.o

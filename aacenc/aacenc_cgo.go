...
#cgo linux,!arm CFLAGS: -g3 -O0 -std=gnu99 -Iexternal/aacenc/include -DUSE_DEFAULT_MEM -Wall
#cgo darwin CFLAGS: -g3 -O0 -std=gnu99 -Iexternal/aacenc/include -DUSE_DEFAULT_MEM -Wall
